...
<head>
    ...
    <script type="text/javascript" src="${ctx }/static/js/tmall/mapping.js"></script>
						...
						<div class="row">
							<div class="col-xs-12">
								<fieldset>
									...
									<button class="btn btn-info" type="button" id="initProductCat" onclick="initProductCat()">
										<i class="icon-ok"></i>
										初始化产品类目
									</button>
								</fieldset>
						...
						<div class="row">
							<div class="col-xs-4">
								<div style="overflow: scroll;">
									<span class="label label-info">天猫目录树</span>
				...
				<!-- <div class="row">
					<div class="col-xs-12">
						<div class="row">
							<div class="col-xs-4">
								<div style="overflow: scroll;">
									<span class="label label-info">天猫属性/值</span>
