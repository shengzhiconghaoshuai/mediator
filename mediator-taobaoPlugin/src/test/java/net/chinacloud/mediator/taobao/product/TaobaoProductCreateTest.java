...
public class TaobaoProductCreateTest {
//	@Before
//	public void Before() {
...
//	}
	...
	public Connector<TaobaoRequest<?>> getTaobaoConnector() {
		ApplicationParam param = new ApplicationParam("12201527",
				...
				"6101f079afb5d1e1412de62d81ab959bc7f411da6531da3173826602",
				null, null, null, null, null);
		Connector connector = new TaobaoConnector(param);
		return connector;
	}
	@Test
	public void taobaoProduct(){
		...
		this.exportSku(outids, "D:/淘宝在售Sku.txt");
		...
		this.exportSku(outids1, "D:/淘宝仓库Sku.txt");
		this.exportOMSSql(onsalelist, "1", "D:/上架初始化.sql");
		onsalelist.addAll(onstocklist);
		this.exportSql(onsalelist);
		this.exportOMSSql(onstocklist, "0","D:/下架初始化.sql");
	}
	//@Test
...
//		System.out.print("nullOutId:"+"----"+outid);
	...
	public Item createItemWithoutSku() {
	 ...
	 public void exportSql(List<ProductPartnumberMapping> tb){
		    System.out.println(tb.size());
		    FileOutputStream out=null;
	        OutputStreamWriter osw=null;
	        BufferedWriter bw=null;
	        try {
	            out = new FileOutputStream(new File("D:/淘宝商品初始化.sql"));
	            ...
	            for(ProductPartnumberMapping tbproduct : tb ) {
	            	...
	            	bw.append("'").append(tbproduct.getChannelProductId()).append("','").append(tbproduct.getOuterId()).append("',").append("0, ").append("3 );").append("\r");
	   		    }
	        } catch (Exception e) {
	        	e.printStackTrace();
	        }finally{
