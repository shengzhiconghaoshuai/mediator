...
public class Sample 
{
	private static String appkey = "68756920";
	
	private static String secret = "DOlelFHb7XL9o9wWxWoj";
	
	private static String topAppkey = ""; // 如果没有TOP appkey，可以不填，样例代码中会使用御城河appkey代替topAppkey
