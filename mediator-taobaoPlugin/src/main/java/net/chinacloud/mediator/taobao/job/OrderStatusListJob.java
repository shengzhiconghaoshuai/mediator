...
public class OrderStatusListJob extends CronJob{
private static final long serialVersionUID = -6973796486690381616L;
	
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderStatusListJob.class);
