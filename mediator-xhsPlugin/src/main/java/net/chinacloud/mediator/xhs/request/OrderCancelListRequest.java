...
public class OrderCancelListRequest extends AbstractRequest implements XhsRequest{
	...
	public String getApiMethodName() {
		return "/ark/open_api/v0/packages/canceling/list";
	}
	...
	public Class<?> getResponseClass() {
		return OrderCancelListResponse.class;
	}
