 ...
 * 描述： 
 */
package net.chinacloud.mediator.job.order;
 ...
 */
public class OrderSupplementJob extends CronJob {

	private static final long serialVersionUID = 6273889285259997375L;
	
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderSupplementJob.class);
	/**
	 * 是否使用数据库记录调度运行时间
	 */
