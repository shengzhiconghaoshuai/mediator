...
public class OrderSupplementTask extends OrderTask {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(OrderSupplementTask.class);
	
	private static final int TASK_INTERVAL_BUFFER = 30;
	
	private static final int TASK_INTERVAL = 1000 * 60 * TASK_INTERVAL_BUFFER;
	
	protected static final String ORDER_SUPPLEMENT_TYPE = "supplement";
	
	static {
		TaskManager.registTask(ORDER_TYPE, ORDER_SUPPLEMENT_TYPE, OrderSupplementTask.class);
	}
